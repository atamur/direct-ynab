...
def load(
    budget_path: Annotated[
        str, typer.Argument(help="Path to the .ynab4 budget directory")
    ],
) -> None:
...
def inspect(
    ...
    accounts: Annotated[
        bool, typer.Option("--accounts", help="Show account details")
    ] = False,
    transactions: Annotated[
        bool, typer.Option("--transactions", help="Show transaction details")
    ] = False,
) -> None:
